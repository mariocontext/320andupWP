...
Port to Wordpress: mario noble https://github.com/mariocontext/320andupWP
-->
...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'threetwentyandup' ), max( $paged, $page ) );
...
<!-- JavaScript -->
<script src="js/jquery-1.7.2.min.js"></script> <!-- may want to remove if already included via wp core -->
